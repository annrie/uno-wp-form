...
/**
 * Uno_WP_Form_Field_Radio
 */
class Uno_WP_Form_Field_Radio extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_radio',
			'display_name'   => __( 'Radio', 'uno-wp-form' ),
		);
	}
