...
/**
 * Unomoon_Form_Field_Radio
 */
class Unomoon_Form_Field_Radio extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_radio',
			'display_name'   => __( 'Radio', 'unomoon-form' ),
		);
	}
