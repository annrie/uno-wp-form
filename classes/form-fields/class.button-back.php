...
/**
 * Uno_WP_Form_Field_Button_Back
 */
class Uno_WP_Form_Field_Button_Back extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_defaults() {
		return array(
			'class'           => null,
			'value'           => 'back',
			'element_content' => __( 'Back', 'uno-wp-form' ),
		);
	}
