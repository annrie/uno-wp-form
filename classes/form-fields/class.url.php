...
/**
 * Uno_WP_Form_Field_Url
 */
class Uno_WP_Form_Field_Url extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_url',
			'display_name'   => _x( 'URL', 'form-field', 'uno-wp-form' ),
		);
	}
