...
/**
 * Unomoon_Form_Field_Url
 */
class Unomoon_Form_Field_Url extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_url',
			'display_name'   => _x( 'URL', 'form-field', 'unomoon-form' ),
		);
	}
