...
/**
 * Unomoon_Form_Field_File
 */
class Unomoon_Form_Field_File extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_file',
			'display_name'   => __( 'File', 'unomoon-form' ),
		);
	}
