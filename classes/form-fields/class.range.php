...
/**
 * Unomoon_Form_Field_Range
 */
class Unomoon_Form_Field_Range extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_range',
			'display_name'   => __( 'Range', 'unomoon-form' ),
		);
	}
