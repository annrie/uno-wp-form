...
/**
 * Uno_WP_Form_Field_Range
 */
class Uno_WP_Form_Field_Range extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_range',
			'display_name'   => __( 'Range', 'uno-wp-form' ),
		);
	}
