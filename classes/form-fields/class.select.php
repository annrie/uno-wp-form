...
/**
 * Uno_WP_Form_Field_Select
 */
class Uno_WP_Form_Field_Select extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_select',
			'display_name'   => __( 'Select', 'uno-wp-form' ),
		);
	}
