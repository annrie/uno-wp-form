...
/**
 * Unomoon_Form_Field_Select
 */
class Unomoon_Form_Field_Select extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_select',
			'display_name'   => __( 'Select', 'unomoon-form' ),
		);
	}
