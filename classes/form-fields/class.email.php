...
/**
 * Unomoon_Form_Field_Email
 */
class Unomoon_Form_Field_Email extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_email',
			'display_name'   => __( 'Email', 'unomoon-form' ),
		);
	}
