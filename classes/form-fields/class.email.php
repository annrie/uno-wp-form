...
/**
 * Uno_WP_Form_Field_Email
 */
class Uno_WP_Form_Field_Email extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_email',
			'display_name'   => __( 'Email', 'uno-wp-form' ),
		);
	}
