...
/**
 * Uno_WP_Form_Field_Zip
 */
class Uno_WP_Form_Field_Zip extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_zip',
			'display_name'   => __( 'Zip Code', 'uno-wp-form' ),
		);
	}
