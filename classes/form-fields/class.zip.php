...
/**
 * Unomoon_Form_Field_Zip
 */
class Unomoon_Form_Field_Zip extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_zip',
			'display_name'   => __( 'Zip Code', 'unomoon-form' ),
		);
	}
