...
/**
 * Unomoon_Form_Field_Button_Confirm
 */
class Unomoon_Form_Field_Button_Confirm extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_bconfirm',
	...
	protected function set_defaults() {
		return array(
			'class'           => null,
			'value'           => 'confirm',
			'element_content' => __( 'Confirm', 'unomoon-form' ),
		);
	}
