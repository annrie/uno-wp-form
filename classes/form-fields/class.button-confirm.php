...
/**
 * Uno_WP_Form_Field_Button_Confirm
 */
class Uno_WP_Form_Field_Button_Confirm extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_bconfirm',
	...
	protected function set_defaults() {
		return array(
			'class'           => null,
			'value'           => 'confirm',
			'element_content' => __( 'Confirm', 'uno-wp-form' ),
		);
	}
