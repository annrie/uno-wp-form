...
/**
 * Unomoon_Form_Field_Text
 */
class Unomoon_Form_Field_Text extends Unomoon_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unomoonform_text',
			'display_name'   => __( 'Text', 'unomoon-form' ),
		);
	}
	...
	public function unomoonform_tag_generator_dialog( array $options = array() ) {
		...
		<p>
			...
			<label><input type="checkbox" name="conv_half_alphanumeric" value="true" <?php checked( 'true', $conv_half_alphanumeric ); ?> /> <?php esc_html_e( 'Convert.', 'unomoon-form' ); ?></label>
		</p>
		<?php
	}
}
