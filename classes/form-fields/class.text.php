...
/**
 * Uno_WP_Form_Field_Text
 */
class Uno_WP_Form_Field_Text extends Uno_WP_Form_Abstract_Form_Field {
	...
	protected function set_names() {
		return array(
			'shortcode_name' => 'unoform_text',
			'display_name'   => __( 'Text', 'uno-wp-form' ),
		);
	}
	...
	public function unoform_tag_generator_dialog( array $options = array() ) {
		...
		<p>
			...
			<label><input type="checkbox" name="conv_half_alphanumeric" value="true" <?php checked( 'true', $conv_half_alphanumeric ); ?> /> <?php esc_html_e( 'Convert.', 'uno-wp-form' ); ?></label>
		</p>
		<?php
	}
}
