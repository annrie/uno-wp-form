...
/**
 * Unomoon_Form_Validation_Rule_MinImageSize
 */
class Unomoon_Form_Validation_Rule_MinImageSize extends Unomoon_Form_Abstract_Validation_Rule {
	...
	public function rule( $name, array $options = array() ) {
		...
		$defaults = array(
			'width'   => 1,
			'height'  => 1,
			'message' => __( 'This image size is too small.', 'unomoon-form' ),
		);
