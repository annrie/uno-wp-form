...
<span class="unomoonform-tel-field">
	<input type="text"
	...
	<input type="text"
		...
		<?php echo Unomoon_Form_Functions::generate_input_attribute( 'class', $fields[2]['class'] ); ?>
		<?php echo Unomoon_Form_Functions::generate_input_attribute( 'size', $fields[2]['size'] ); ?>
		<?php echo Unomoon_Form_Functions::generate_input_attribute( 'maxlength', $fields[2]['maxlength'] ); ?>
		<?php echo Unomoon_Form_Functions::generate_input_attribute( 'value', $fields[2]['value'] ); ?>
		<?php echo Unomoon_Form_Functions::generate_input_attribute( 'data-conv-half-alphanumeric', $fields[2]['conv-half-alphanumeric'] ); ?>
	/>
</span>
