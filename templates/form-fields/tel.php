...
<span class="unomoonform-tel-field">
	...
	<input type="text"
		...
		<?php Unomoon_Form_Functions::input_attribute( 'class', $fields[2]['class'] ); ?>
		<?php Unomoon_Form_Functions::input_attribute( 'size', $fields[2]['size'] ); ?>
		<?php Unomoon_Form_Functions::input_attribute( 'maxlength', $fields[2]['maxlength'] ); ?>
		<?php Unomoon_Form_Functions::input_attribute( 'value', $fields[2]['value'] ); ?>
		<?php Unomoon_Form_Functions::input_attribute( 'data-conv-half-alphanumeric', $fields[2]['conv-half-alphanumeric'] ); ?>
	/>
</span>
